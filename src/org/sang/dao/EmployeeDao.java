...
public class EmployeeDao {
    ...
    public Employee getEmpById(int id){
        ...
        try {
            ...
            if (rs.next()) {
                ...
                employee = new Employee(employeeid,employeename,username,phone,email,status,departmentid,password,role,sex,idno);
            }
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SQLException e) {
    ...
    public List<Employee> getUnApproveaccount() {
        ...
        try {
            con = DBUtils.getConnection();
            ps = con.prepareStatement("SELECT * FROM employee WHERE status=0 AND role =3");
            rs = ps.executeQuery();
            while (rs.next()) {
    ...
    public int reg(Employee employee) {
        ...
        try {
            con = DBUtils.getConnection();
            ps = con.prepareStatement("INSERT INTO employee(employeename,username,phone,email,status,departmentid,password,role,idno,sex) VALUES (?,?,?,?,?,?,?,?,?,?)");
            ...
            ps.setInt(8, 3);
            ps.setString(9,employee.getIdno());
            ps.setString(10,employee.getSex());
            return ps.executeUpdate();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SQLException e) {
