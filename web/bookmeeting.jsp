            ...
            <fieldset>
                ...
                <table class="formtable">
                    ...
                    <tr>
                        <td>预计开始时间：</td>
                        <td>
                            <input class="Wdate" type="text" id="starttime" value="" name="starttime"
                    ...
                    <tr>
                        <td>预计结束时间：</td>
                        <td>
                            <input class="Wdate" type="text" id="endtime" value="" name="endtime"
                                   onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                        </td>
                    </tr>
                    <tr>
                        <td>宾馆名称及地点：</td>
                        <td>
                            <input type="text" id="hotelname" name="hotelname" maxlength="20"/>
                        </td>
                    </tr>
                    <tr>
                        <td>会议室名称：</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <tr>
                                <td>姓名:</td>
                                <td>
                                    <input type="radio" name="employeename" value="yes"/>需要
                                    <input type="radio" name="employeename" value="no"/>不需要
                                </td>
                            </tr>
                            <tr>
                                <td>工作单位:</td>
                                <td>
                                    <input type="radio" name="departmentname" value="yes"/>需要
                                    <input type="radio" name="departmentname" value="no"/>不需要
                                </td>
                            </tr>
                            <tr>
                                <td>身份证:</td>
                                <td>
                                    <input type="radio" name="noid" value="yes"/>需要
                                    <input type="radio" name="noid" value="no"/>不需要
                                </td>
                            </tr>
                            <tr>
                                <td>联系电话:</td>
                                <td>
                                    <input type="radio" name="phone" value="yes"/>需要
                                    <input type="radio" name="phone" value="no"/>不需要
                                </td>
                            </tr>
                            <tr>
                                <td>参会时间:</td>
                                <td>
                                    <input type="radio" name="time" value="yes"/>需要
                                    <input type="radio" name="time" value="no"/>不需要
                                </td>
                            </tr>
                            <tr>
                                <td>性别:</td>
                                <td>
                                    <input type="radio" name="sex" value="yes"/>需要
                                    <input type="radio" name="sex" value="no"/>不需要
                                </td>
                            </tr>
                            <tr>
                                <td>是否需要房间:</td>
                                <td>
                                    <input type="radio" name="room" value="yes"/>需要
                                    <input type="radio" name="room" value="no"/>不需要
                                </td>
                            </tr>
