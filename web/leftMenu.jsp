...
<div class="page-sidebar">
    ...
    <div class="sidebar-menugroup">
        ...
        <ul class="sidebar-menu">
            <li class="sidebar-menuitem"><a href="approveattend">会议请求</a></li>

            <c:if test="${loginUser.role!=3}">
                <li class="sidebar-menuitem"><a href="approveinput">会议申请审批</a></li>
                ...
                <li class="sidebar-menuitem"><a href="attendmeeting.jsp">参加会议</a></li>
            <c:if test="${loginUser.role==1}">
